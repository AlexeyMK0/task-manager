...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> BadResonseHandler(HttpMessageNotReadableException exception) {
        logger.error("processing HttpMessageNotReadableException", exception);
